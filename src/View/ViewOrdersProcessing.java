...
public class ViewOrdersProcessing extends JFrame {
    ...
    public ViewOrdersProcessing() {
        ...
        lblTitle = new JLabel("Processing Orders");
        ...
        for (int i = 0; i < Controller.dbord.size(); i++) {
            if (Controller.dbord.get(i).getOrderStatus() == 0) {
